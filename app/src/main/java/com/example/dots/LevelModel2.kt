...
class LevelModel2(screenSizes: ScreenSizes) {
    public val amountFigure: Float = 48F;
    ...
    public val onePercentHeight: Float = ((screenSizes.height - 600).toFloat() / 100)
    ...
    public val freeSpaceHeight: Float = (100F - (amountRows * circleRadiusHeight)).toFloat()

    public val ofx: Float = ((freeSpaceWidth / (amountFigureInRow + 1)) * onePercentWidth)
    public val ofy: Float = ((freeSpaceHeight /  (amountRows + 1)) * onePercentHeight)
